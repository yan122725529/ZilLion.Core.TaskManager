...
namespace ZilLion.Core.QuartzWrapper.Quartz
{
    public class SchedulerContainer
    {
        ...
        ///     任务程序集根目录
        /// </summary>
        private  ITaskRunLogRespository _taskRunLogRespository ;

        private Assembly _assembly;
        private bool _hasinited;
        private TaskRunnerConfig _runnerConfig;
        public TaskRunnerConfig RunnerConfig => _runnerConfig;
        ...
        public void StartScheduler()
        {
            try
            {
                ...
                //添加全局监听
                _scheduler.ListenerManager.AddTriggerListener(new CustomTriggerListener(_runnerConfig),
