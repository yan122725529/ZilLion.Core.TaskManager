...
namespace DapperExtensions
{
    public interface IDapperImplementor
    {
        ...
        bool CreateTable<T>(IDbConnection connection, T entity, string tempdbname, short DbRowSn) where T : class;
    }
    ...
    public class DapperImplementor : IDapperImplementor
    {
        ...
        public bool CreateTable<T>(IDbConnection connection, T entity, string tempdbname, short DbRowSn) where T : class
        {
            IClassMapper classMap = SqlGenerator.Configuration.GetMap<T>();
            string sql = SqlGenerator.CreateTable(classMap, tempdbname, DbRowSn);
