...
namespace DapperExtensions.Mapper
{
    ...
    public class PropertyMap : IPropertyMap
    {
        ...
        /// <summary>
        /// Gets the ignore stat of the current property. If ignored, the current property will not be included in queries.
        /// </summary>
        public bool Ignored { get; private set; }

        /// <summary>
        /// Gets the read-only stat of the current property. If read-only, the current property will not be included in INSERT and UPDATE queries.
        /// </summary>
        ...
        /// <summary>
        /// Fluently sets the ignore stat of the property.
        /// </summary>
        ...
        /// <summary>
        /// Fluently sets the read-only stat of the property.
        /// </summary>
