...
namespace DapperExtensions
{
    public static class DapperExtensions
    {
        ...
        {
            Configure(typeof(AutoClassMapper<>), new List<Assembly>(), new SqliteDialect());
        }
        ...
        /// createTable table
        /// </summary>
        public static bool CreateTable<T>(this IDbConnection connection, T entity, string tempdbname, short dbRowSn=0) where T : class
        {
            return Instance.CreateTable<T>(connection, entity, tempdbname, dbRowSn);
        }
        ...
        /// If the mapper for the type is not yet created, a new mapper is generated from the mapper type specifed by DefaultMapper.
        /// </summary>
        public static IClassMapper GetMapIncludeForeignKey<T>() where T : class
        {
            return Instance.SqlGenerator.Configuration.GetMapIncludeForeignKey(typeof(T));
        }
