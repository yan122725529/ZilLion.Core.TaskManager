...
namespace Dapper
{
    ...
    public struct CommandDefinition
    {
        ...
        /// <summary>
        /// For asynchrono operations, the cancellation-token
        /// </summary>
        ...
        private static void PassByPosition(IDbCommand cmd)
        {
            ...
            cmd.CommandText = pseudoPositional.Replace(cmd.CommandText, match =>
            {
                ...
                else if (parameters.TryGetValue(key, out param))
                {
                    ...
                    // if found, return the anonymo token "?"
...
#pragma warning restore 618
        ...
        {
            // no point using special per-type handling here; it boils down to the same, pl not all are supported anyway (see: SqlDataReader.GetChar - not supported!)
#pragma warning disable 618
            if (type == typeof(char))
...
#pragma warning restore 618
    ...
    partial class DynamicParameters : SqlMapper.IDynamicParameters, SqlMapper.IParameterLookup, SqlMapper.IParameterCallbacks
    {
        ...
        /// construct a dynamic parameter bag
        /// </summary>
        /// <param name="template">can be an anonymo type or a DynamicParameters bag</param>
