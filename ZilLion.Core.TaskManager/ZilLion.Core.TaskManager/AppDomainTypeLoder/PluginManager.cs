namespace ZilLion.Core.TaskManager.AppDomainTypeLoder
{
    ...
    public class PluginManager
    {
        ...
        //private readonly ConcurrentDictionary<string, TaskPluginCallerProxy> _plugins =
        //    new ConcurrentDictionary<string, TaskPluginCallerProxy>();
        ...
        //                {
        //                    //加载
        //                    var loader = new TaskPluginLoader(e.Name);
        //                    var proxy = new TaskPluginCallerProxy(loader);
        ...
        //                {
        //                    TaskPluginCallerProxy proxy;
        //                    if (_plugins.TryRemove(e.Name, out proxy))
        //                    {
        //                        OnPluginChanged(this, e);
        //                        var loader = proxy.TaskPluginLoader;
        //                        proxy.TaskPluginLoader = null;
        //                        loader.Unload();
        //                    }
        //                }
        ...
        //                        var loader = proxy.TaskPluginLoader;
        //                        loader.Unload();
        //                        loader = new TaskPluginLoader(e.Name);
        //                        proxy.TaskPluginLoader = loader;
        //                        OnPluginChanged(this, e);
        //                    }
        //                }
