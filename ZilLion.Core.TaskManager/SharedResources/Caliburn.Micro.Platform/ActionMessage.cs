...
namespace Caliburn.Micro
{
    ...
    /// <summary>
    ///     Used to send a message from the UI to a presentation model class, indicating that a particular Action should be
    ///     invoked.
    /// </summary>
#if WinRT
    ...
    public class ActionMessage : TriggerAction<FrameworkElement>, IHaveParameters
    {
        ...
        private static IEnumerable<string> BuildPossibleGuardNames(ActionExecutionContext context)
        {
