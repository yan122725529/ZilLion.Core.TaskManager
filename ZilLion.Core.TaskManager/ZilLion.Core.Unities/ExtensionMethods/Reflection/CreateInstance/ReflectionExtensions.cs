...
using ZilLion.Core.Unities.ExtensionMethods.Reflection.CreateInstance;
...
public static partial class Extensions
{
		...
		private static readonly Hashtable SGetterDict = Hashtable.Synchronized(new Hashtable(10240));
		private static readonly Hashtable SSetterDict = Hashtable.Synchronized(new Hashtable(10240));
		private static readonly Hashtable SMethodDict = Hashtable.Synchronized(new Hashtable(10240));
        private static readonly Hashtable SPropertyDict = Hashtable.Synchronized(new Hashtable(10240));
		...
		public static object FastGetValue(this FieldInfo fieldInfo, object obj)
		{
			...
			GetValueDelegate getter = (GetValueDelegate)SGetterDict[fieldInfo];
			if( getter == null ) {
				getter = DynamicMethodFactory.CreateFieldGetter(fieldInfo);
				SGetterDict[fieldInfo] = getter;
			}
		...
		public static void FastSetField(this FieldInfo fieldInfo, object obj, object value)
		{
			...
			SetValueDelegate setter = (SetValueDelegate)SSetterDict[fieldInfo];
			if( setter == null ) {
				setter = DynamicMethodFactory.CreateFieldSetter(fieldInfo);
				SSetterDict[fieldInfo] = setter;
			}
